...
c & d
? 2147483648 ^ g ^ e ^ f: c | d
? 1073741824 & g
? 3221225472 ^ g ^ e ^ f: 1073741824 ^ g ^ e ^ f: g ^ e ^ f
);
}
function d(a, b, c) {
return (a & b) | (~a & c);
...
128 > d
? (b += String.fromCharCode(d)): d > 127 && 2048 > d
...
func GetLensId(e string) string {
	...
	(function getLensId(e) {
		if (e) {
		  for (var t, o = e.split(","), i = 0; i < o.length; i++)
			"lensId" === o[i].split(":")[0] && (t = o[i].split(":")[1]);
		  return t;
		}
	  })('%s')
	`, e))
